...
let mainDish = [
	...
	},
	{
		...
		instructions:
			'put everything together in a mixer and mix for 5 minutes on medium speed.  let rise for 2 hours.  shape into a loaf and let rise for another hour.  bake at 450 for 30 minutes',
		servingInfo:
			'Serves 2, 10 minutes to prepare, 5 minutes to cook, 500 calories per serving',
		category: 'Side',
	},
	{
		...
		ingredients: [
			{ amount: '4', ingredient: 'carrots' },
			{ amount: '1', ingredient: 'avacado' },
			{ amount: '10 g', ingredient: 'diced mint' },
			{ amount: '1 cup', ingredient: 'cup Maple Syrup' },
		],
		instructions:
			'rub carrots in olive oil salt and pepper to taste.  grill for 12 minutes, flipping half way.  Mix with min, maple and sliced avacado',
		servingInfo:
			'Serves 2, 10 minutes to prepare, 5 minutes to cook, 500 calories per serving',
		category: 'Vegetable',
	},
...
let recipes = [
	...
	},
	{
		...
		ingredients: [
			{
				amount: '1 lb',
				ingredient: 'extra lean or lean ground beef or ground turkey',
			},
			...
			{
				amount: '16 oz',
				ingredient: ' frozen tater tots half cups grated cheddar cheese',
			},
		],
	...
	},
	{
		...
		instructions:
			'toss with olive oil, salt and pepper.  Place on cookie sheet covered with tinfoil.  Broil at 425 for 20-25 minutes',
		category: 'Vegetable',
	},
	{
		id: '006',
		...
		ingredients: [
			{ amount: '1/4 cup', ingredient: 'Peanut butter' },
		...
		instructions:
			'Sear the meat, add the veggies, add the coconut milk and spices, simmer for 20 minutes',
		category: 'Entree',
	},
	{
		id: '007',
	...
	},
	{
		...
		ingredients: [
			...
			{
				amount: '1 bunch',
				ingredient: 'Parsley, or sub for cilantro if you must',
			},
